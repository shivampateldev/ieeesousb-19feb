        ...
        <div className="w-full mx-auto px-6 sm:px-10 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10 mb-8 md:mb-10">
            ...
            <div className="reveal fade-up delay-3">
              ...
              {/* Contact content */}
              <div className={cn(
                "lg:block space-y-5 transition-all duration-500",
                expandedSection === 'contact' ? 'block' : 'hidden lg:block'
              )}>
                <div className="flex flex-col items-center gap-4">
                  <a href="tel:+917966046304" className="flex items-center gap-4 group outline-none">
                  ...
                  <div className="flex items-center gap-4">
                    <Mail className="h-4 w-4 text-primary transition-transform duration-300 hover:scale-110" />
                    <div className="flex flex-col gap-2 text-sm text-muted-foreground text-center">
                      <a
                        ...
                        className="hover:text-primary transition-all duration-300 hover:translate-x-1 whitespace-nowrap"
                      >
