            ...
            <section className="mb-12 theme-card theme-card-blue">
              ...
              <TypingSequenceGroup>
                ...
                <p>
                  <TypingAnimation
                    sequenceIndex={3}
                    text="With its continued commitment to technological progress, IEEE remains at the forefront of electrical, electronic, and computing advancements, driving innovation and shaping the future of modern civilization."
                  />
                </p>
              </TypingSequenceGroup>
            </section>
